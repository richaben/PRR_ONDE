...
#####-----------
### plot 3 modalites
plot_bilan_prop(df_categ_obs_3mod_reg, lib_ecoulement = lib_ecoul3mod, regional = T)
```

#### Typologie départementale

```{r fig.height = 5.5, fig.width = 8, align = "center", warning = FALSE}
plot_bilan_prop(df_categ_obs_4mod_reg, lib_ecoulement = lib_ecoul4mod, regional = T)
```
